...
var fileDescriptor_116e343673f7ffaf = []byte{
	...
	0xd2, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x01, 0xb1, 0x95, 0x0c, 0xb8, 0x58, 0x42, 0x8b,
	...
	0x84, 0xa3, 0x64, 0xc0, 0xc5, 0xe7, 0x97, 0x5a, 0x0e, 0xd2, 0x14, 0x94, 0x5a, 0x58, 0x9a, 0x5a,
	0x5c, 0x22, 0x24, 0xc7, 0x05, 0x36, 0x0b, 0xac, 0x97, 0xdb, 0x88, 0x4b, 0x0f, 0x6c, 0x09, 0x58,
	0x01, 0xc4, 0x0e, 0x6d, 0x2e, 0x7e, 0xb8, 0x8e, 0xe2, 0x82, 0xfc, 0xbc, 0xe2, 0x54, 0x21, 0x09,
	0x2e, 0xf6, 0xe2, 0xd2, 0xe4, 0xe4, 0xd4, 0xe2, 0x62, 0xb0, 0x2e, 0x8e, 0x20, 0x18, 0xd7, 0xc8,
	0x0b, 0x6e, 0x7c, 0x70, 0x6a, 0x51, 0x59, 0x66, 0x72, 0xaa, 0x90, 0x05, 0x17, 0x3b, 0x54, 0x44,
	0x48, 0x04, 0x62, 0x36, 0xaa, 0xfd, 0x52, 0xa2, 0x68, 0xa2, 0x10, 0x3b, 0x94, 0x18, 0x9c, 0xd8,
	0xa2, 0xc0, 0x0e, 0x48, 0x62, 0x03, 0xfb, 0xd8, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0xbe, 0x90,
	0x99, 0x90, 0xff, 0x00, 0x00, 0x00,
}
...
// NewUserServiceClient is the client API for NewUserService service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
type NewUserServiceClient interface {
	// Unary
	NewUser(ctx context.Context, in *NewUserRequest, opts ...grpc.CallOption) (*NewUserResponse, error)
}

type newUserServiceClient struct {
	cc *grpc.ClientConn
}

func NewNewUserServiceClient(cc *grpc.ClientConn) NewUserServiceClient {
	return &newUserServiceClient{cc}
}

func (c *newUserServiceClient) NewUser(ctx context.Context, in *NewUserRequest, opts ...grpc.CallOption) (*NewUserResponse, error) {
	out := new(NewUserResponse)
	err := c.cc.Invoke(ctx, "/user.NewUserService/NewUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// NewUserServiceServer is the server API for NewUserService service.
type NewUserServiceServer interface {
	// Unary
	NewUser(context.Context, *NewUserRequest) (*NewUserResponse, error)
}

func RegisterNewUserServiceServer(s *grpc.Server, srv NewUserServiceServer) {
	s.RegisterService(&_NewUserService_serviceDesc, srv)
}

func _NewUserService_NewUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NewUserRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NewUserServiceServer).NewUser(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.NewUserService/NewUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NewUserServiceServer).NewUser(ctx, req.(*NewUserRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _NewUserService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "user.NewUserService",
	HandlerType: (*NewUserServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "NewUser",
			Handler:    _NewUserService_NewUser_Handler,
		},
	},
